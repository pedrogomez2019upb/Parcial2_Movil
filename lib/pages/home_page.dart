...
import 'package:parcial2/providers/providers.dart';
import 'package:parcial2/utils/utils.dart';
...
class HomePageState extends State<HomePage> {
  ...
  final List<PopupChoices> choices = <PopupChoices>[
    PopupChoices(title: 'Opciones', icon: Icons.settings),
    PopupChoices(title: 'Salirse', icon: Icons.exit_to_app),
  ];
  ...
  void showNotification(RemoteNotification remoteNotification) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      Platform.isAndroid ? 'com.example.parcial2' : 'com.example.parcial2',
      'Parcial 2',
      playSound: true,
